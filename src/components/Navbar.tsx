...
import resumePDF from "../assets/anish_frontend.pdf";
...
const Navbar: React.FC<NavbarProps> = ({ theme, onThemeChange }) => {
  ...
  const navLinkClass =
    "px-3 py-2 text-sm font-medium relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-gray-900 dark:after:bg-gray-100 after:transition-all after:duration-300 hover:after:w-full";
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link
                to="/"
                className="text-xl font-bold text-gray-900 dark:text-white h-8 w-8"
              >
          ...
          <div className="hidden md:flex items-center">
            <div className="hidden md:flex space-x-4">
              ...
              <a href={resumePDF} download className={navLinkClass}>
                Resume
              </a>
            </div>
